...
CREATE TABLE `expozice` (
	...
	`od` date NOT NULL,
	`do` date NOT NULL,
	`id_zamestnanece` int(11) NOT NULL,
	PRIMARY KEY (`id_expozice`)
) AUTO_INCREMENT=1;

INSERT INTO `expozice` (`id_expozice`, `typ`, `umelec`, `od`, `do`, `id_zamestnanece`) VALUES
...
INSERT INTO `mistnost` (`id_mistnost`, `typ_exp`, `plocha`, `cena`, `tvar`, `id_zamestnanece`) VALUES
...
INSERT INTO `objednavka` (`id_objednavka`, `od`, `do`, `poplatek`, `id_pronajimatele`, `id_expozice`, `id_zamestnanece`) VALUES
...
INSERT INTO `umelec` (`id_umelec`, `jmeno`, `prijmeni`, `specializace`, `id_zamestnanece`) VALUES
...
CREATE TABLE `zamestnanec` (
	`id_zamestnanec` int(11) unseigned NOT NULL AUTO_INCREMENT,
	`jmeno` varchar(40)	NOT NULL,
	`prijmeni` varchar(40) NOT NULL,
